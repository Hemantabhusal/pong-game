...
def show_end_screen(screen, winner_text):
    """
    Displays the end screen with the winner text and options to play again, go back to the home screen, or exit.
    Returns "play_again", "home", or "exit" based on the user's choice.
    """
